...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss_from_real = bce_loss(logits_real, torch.ones_like(logits_real).type(dtype))
    loss_from_fake = bce_loss(logits_fake, torch.zeros_like(logits_fake).type(dtype))
    loss = loss_from_real + loss_from_fake
