...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        h0, image_features_cache = affine_forward(features, W_proj, b_proj)
        ...
        if self.cell_type == 'rnn':
          ...
          h, lstm_cache = lstm_forward(word_vectors, h0, Wx, Wh, b)

        scores, affine_cache = temporal_affine_forward(h, W_vocab, b_vocab)
        loss, dout = temporal_softmax_loss(scores, captions_out, mask)

        # backward and grads
        dtemp, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dout, affine_cache)
        ...
        dfeatures, grads['W_proj'], grads['b_proj'] = affine_backward(dh0, image_features_cache)
